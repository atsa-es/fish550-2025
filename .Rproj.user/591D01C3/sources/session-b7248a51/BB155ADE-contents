...
* Read over the background material on MARSS and the Lab2-MARSS.Rmd in the Lab-2 folder.

* Do a pull of the `fish550-2025` repository so you have the most updated version.

* Copy [Lab-2-template](https://github.com/atsa-es/fish550-2025/tree/main/Lab-2) into your team folder.
